...
namespace MVC.Core
{
    ...
    {
        public GameUIFactory GameUIFactory { get; set; }
        [SerializeField] private ConfigLoader _configLoader;
        [field: SerializeField] public GameObject SpaceShipDeathView { get;set; }
        ...
        private void Awake()
        {
            ...
            GameUIFactory = new GameUIFactory(_controllers, _dataProvider, _viewProvider, _dataFactory);
