...
namespace DualSenseSample.Inputs
{
    ...
    public class DualSenseTrigger : AbstractDualSenseBehaviour
    {
        ...
        [SerializeField] float ValueRightStickStart;
        [SerializeField] float ValueRightStickEnd;
        [SerializeField] float ValueRightStickForce;
        ...
        private void Update()
        {
            ...
            RightSectionEndPosition = ValueRightStickEnd;
            RightEffectStartPosition = ValueRightStickStart;
            RightSectionForce = ValueRightStickForce;
