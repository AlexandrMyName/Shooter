...
namespace Core
{
    ...
    public class ComponentsStorage : MonoBehaviour, IComponentsStorage
    {
        ...
        public void InitComponents()
        {
            ...
            WeaponData.InitComponent(RecoilCommand, CrossHairTarget.transform);
            AnimatorIK.InitComponent(this, WeaponData);
            WeaponInventory.InitComponent(WeaponData, AnimatorIK);
        }
    }
}